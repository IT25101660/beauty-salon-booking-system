...
public class Review {
    ...
    public void setStylistName(String stylistName) { this.stylistName = stylistName == null ? "" : stylistName; }
    ...
    public String getReviewType() { return "Review"; }

    public String getCustomerViewHeader() { return "Customer Review"; }

    public String getAdminViewHeader() { return "Admin View"; }
